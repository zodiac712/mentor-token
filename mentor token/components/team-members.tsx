...
export default function TeamMembers() {
  ...
  const secondRowMembers = teamMembers.slice(4); // Dominic and James
  ...
  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center gap-8 flex-wrap"> {/* Use flex and justify-center for centering */}
